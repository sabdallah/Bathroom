...
public class DeleteReviewServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        int index = 1; // index of review in JSON array, needs to be passsed in from html somehow
        response.setContentType("text/html");
      JSONArray userReviewList  = new JSONArray(); // passed in from html page in reality
      userReviewList.remove(index);
    }
